<?php
    ...
    if(isset($_POST['username']) && isset($_POST['password'])){
        ...
        $conn->loginUser($_POST['username'], $_POST['password']);
    }
...
<div class="container">
    ...
    <div class="login-container">
        ...
        <form class="login-form" method="post">
            ...
            <button type="button" class="button-register"><a href="register.php"><b>Registar</b></button>
        </form>
    </div>
